...
gulp.task('scripts', function() {
    ...
    return gulp.src( [themePath + 'src/scripts/plugins/**/*.js', themePath + 'src/scripts/development/**/*.js'] )
        .pipe(plumber())
...
gulp.task( 'watch', function() {
    ...
    // Watch js files
    gulp.watch( themePath + 'src/scripts/development/**/*.js', gulp.series( 'scripts' ) ).on('change',browserSync.reload);
});
